...
echo "🛠️ Injecteren van tijdframe-tabbladen in detail.html..."

TARGET="frontend/html/detail.html"

# Voeg HTML-tabstructuur onder de chart in
...
# Voeg JS toe onderaan script
awk '/renderIndicators\(\)/ {
    print;
    print "";
...
echo "✅ Tabs + logic succesvol toegevoegd aan $TARGET"
