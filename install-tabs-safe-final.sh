...
echo "🛠️ Injectie van tabs en JS onderaan body in detail.html..."

TARGET="frontend/html/detail.html"

# Voeg HTML-tabstructuur toe onder de chart-container
...
# Voeg nieuw <script> blok toe vlak voor </body>
awk '/<\/body>/ {
    print "<script>";
    print "// ✅ Tijdframe tabs click handler + chart update";
...
echo "✅ Tabs + logica zijn nu volledig veilig geplaatst onderaan <body>"
