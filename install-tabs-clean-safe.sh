...
echo "🛠️ Injectie van tabs en JS binnen <script> tag in detail.html..."

TARGET="frontend/html/detail.html"

# Stap 1: Voeg de tab HTML toe NA de chart container
...
# Stap 2: Voeg veilige JS toe BINNEN de laatste </script> blok
awk '/<\/script>/ && !done {
    print "";
...
echo "✅ Tabs + JS veilig geïnjecteerd in $TARGET"
